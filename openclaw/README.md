...
| `wiring/marketplace.json` | `plugin` | Marketplace manifest describing the `lukehinds` plugin registry |
| `wiring/known-marketplaces.json` | `plugin` | Registers the `lukehinds` marketplace in OpenClaw's known-marketplaces list |
